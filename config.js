...
const config = {
  ...
  // String Values
  SESSION_ID: process.env.SESSION_ID || "RGNK~YwoTlVk9", // Put your session
  HANDLERS:
  ...
  BOT_INFO:
    ...
    "４ｐＦ๛Trappy;𝚃𝚁𝙰𝙲𝙴𝚁𝚃𝙴𝙲𝙷-𝙼𝙳;https://i.ibb.co/s2wCJ0p/AddText.png", // YourName;BotName;Image/VideoLink
